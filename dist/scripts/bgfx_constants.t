...
m.BGFX_CAPS_GRAPHICS_DEBUGGER = 0x80ULL
m.BGFX_CAPS_HIDPI = 0x100ULL
m.BGFX_CAPS_HMD = 0x200ULL
m.BGFX_CAPS_INDEX32 = 0x400ULL
m.BGFX_CAPS_INSTANCING = 0x800ULL
m.BGFX_CAPS_OCCLUSION_QUERY = 0x1000ULL
m.BGFX_CAPS_RENDERER_MULTITHREADED = 0x2000ULL
m.BGFX_CAPS_SWAP_CHAIN = 0x4000ULL
m.BGFX_CAPS_TEXTURE_2D_ARRAY = 0x8000ULL
m.BGFX_CAPS_TEXTURE_3D = 0x10000ULL
m.BGFX_CAPS_TEXTURE_BLIT = 0x20000ULL
m.BGFX_CAPS_TEXTURE_COMPARE_ALL = 0xc0000ULL
m.BGFX_CAPS_TEXTURE_COMPARE_LEQUAL = 0x80000ULL
m.BGFX_CAPS_TEXTURE_CUBE_ARRAY = 0x100000ULL
m.BGFX_CAPS_TEXTURE_READ_BACK = 0x200000ULL
m.BGFX_CAPS_VERTEX_ATTRIB_HALF = 0x400000ULL
m.BGFX_CAPS_VERTEX_ATTRIB_UINT10 = 0x800000ULL
