...
if("${CMAKE_GENERATOR}" MATCHES "Visual Studio 14 2015")
    ...
    set(bgfx_CONFIGURE_COMMAND "${CMAKE_COMMAND}" -E env "BX_DIR=${bx_DIR}" "${bx_GENIE}${CMAKE_EXECUTABLE_SUFFIX}" --with-tools --with-tools --with-shared-lib "${bgfx_COMPILER}")
...
elseif("${CMAKE_GENERATOR}" STREQUAL "Unix Makefiles")
    set(bgfx_CONFIGURE_COMMAND "${CMAKE_COMMAND}" -E env "BX_DIR=${bx_DIR}" "${bx_GENIE}${CMAKE_EXECUTABLE_SUFFIX}" --with-tools --with-tools --with-shared-lib "--gcc=${bgfx_GENIE_GCC}" gmake)
