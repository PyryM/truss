...
set(sfml_LIBRARY "${SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sfml-system${CMAKE_SHARED_LIBRARY_SUFFIX}.2")
set(sfml_LIBRARIES
    "${SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sfml-audio${CMAKE_SHARED_LIBRARY_SUFFIX}.2"
    "${SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sfml-graphics${CMAKE_SHARED_LIBRARY_SUFFIX}.2"
    "${SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sfml-network${CMAKE_SHARED_LIBRARY_SUFFIX}.2"
    "${SOURCE_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sfml-window${CMAKE_SHARED_LIBRARY_SUFFIX}.2"    
)
