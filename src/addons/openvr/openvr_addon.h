...
TRUSS_C_API uint32_t tr_ovw_DriverDebugRequest(vr::IVRSystem* self, vr::TrackedDeviceIndex_t unDeviceIndex, char * pchRequest, char * pchResponseBuffer, uint32_t unResponseBufferSize);
...
TRUSS_C_API vr::EVRTrackedCameraError tr_ovw_GetCameraIntrinsics(vr::IVRTrackedCamera* self, vr::TrackedDeviceIndex_t nDeviceIndex, vr::EVRTrackedCameraFrameType eFrameType, vr::HmdVector2_t * pFocalLength, vr::HmdVector2_t * pCenter);
TRUSS_C_API vr::EVRTrackedCameraError tr_ovw_GetCameraProjection(vr::IVRTrackedCamera* self, vr::TrackedDeviceIndex_t nDeviceIndex, vr::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, vr::HmdMatrix44_t * pProjection);
...
TRUSS_C_API vr::EVRApplicationError tr_ovw_LaunchApplication(vr::IVRApplications* self, char * pchAppKey);
TRUSS_C_API vr::EVRApplicationError tr_ovw_LaunchTemplateApplication(vr::IVRApplications* self, char * pchTemplateAppKey, char * pchNewAppKey, vr::AppOverrideKeys_t * pKeys, uint32_t unKeys);
TRUSS_C_API vr::EVRApplicationError tr_ovw_LaunchApplicationFromMimeType(vr::IVRApplications* self, char * pchMimeType, char * pchArgs);
TRUSS_C_API vr::EVRApplicationError tr_ovw_LaunchDashboardOverlay(vr::IVRApplications* self, char * pchAppKey);
...
TRUSS_C_API vr::EVRApplicationError tr_ovw_SetApplicationAutoLaunch(vr::IVRApplications* self, char * pchAppKey, bool bAutoLaunch);
TRUSS_C_API bool tr_ovw_GetApplicationAutoLaunch(vr::IVRApplications* self, char * pchAppKey);
TRUSS_C_API vr::EVRApplicationError tr_ovw_SetDefaultApplicationForMimeType(vr::IVRApplications* self, char * pchAppKey, char * pchMimeType);
TRUSS_C_API bool tr_ovw_GetDefaultApplicationForMimeType(vr::IVRApplications* self, char * pchMimeType, char * pchAppKeyBuffer, uint32_t unAppKeyBufferLen);
TRUSS_C_API bool tr_ovw_GetApplicationSupportedMimeTypes(vr::IVRApplications* self, char * pchAppKey, char * pchMimeTypesBuffer, uint32_t unMimeTypesBuffer);
TRUSS_C_API uint32_t tr_ovw_GetApplicationsThatSupportMimeType(vr::IVRApplications* self, char * pchMimeType, char * pchAppKeysThatSupportBuffer, uint32_t unAppKeysThatSupportBuffer);
...
TRUSS_C_API void tr_ovw_SetWorkingCollisionBoundsTagsInfo(vr::IVRChaperoneSetup* self, uint8_t * pTagsBuffer, uint32_t unTagCount);
TRUSS_C_API bool tr_ovw_GetLiveCollisionBoundsTagsInfo(vr::IVRChaperoneSetup* self, uint8_t * pTagsBuffer, uint32_t * punTagCount);
TRUSS_C_API bool tr_ovw_SetWorkingPhysicalBoundsInfo(vr::IVRChaperoneSetup* self, vr::HmdQuad_t * pQuadsBuffer, uint32_t unQuadsCount);
TRUSS_C_API bool tr_ovw_GetLivePhysicalBoundsInfo(vr::IVRChaperoneSetup* self, vr::HmdQuad_t * pQuadsBuffer, uint32_t * punQuadsCount);
TRUSS_C_API bool tr_ovw_ExportLiveToBuffer(vr::IVRChaperoneSetup* self, char * pBuffer, uint32_t * pnBufferLength);
TRUSS_C_API bool tr_ovw_ImportFromBufferToWorking(vr::IVRChaperoneSetup* self, char * pBuffer, uint32_t nImportFlags);
...
TRUSS_C_API vr::EVROverlayError tr_ovw_FindOverlay(vr::IVROverlay* self, char * pchOverlayKey, vr::VROverlayHandle_t * pOverlayHandle);
TRUSS_C_API vr::EVROverlayError tr_ovw_CreateOverlay(vr::IVROverlay* self, char * pchOverlayKey, char * pchOverlayFriendlyName, vr::VROverlayHandle_t * pOverlayHandle);
...
TRUSS_C_API vr::EVROverlayError tr_ovw_SetOverlayTransformTrackedDeviceComponent(vr::IVROverlay* self, vr::VROverlayHandle_t ulOverlayHandle, vr::TrackedDeviceIndex_t unDeviceIndex, char * pchComponentName);
...
TRUSS_C_API bool tr_ovw_HandleControllerOverlayInteractionAsMouse(vr::IVROverlay* self, vr::VROverlayHandle_t ulOverlayHandle, vr::TrackedDeviceIndex_t unControllerDeviceIndex);
...
TRUSS_C_API vr::EVROverlayError tr_ovw_SetOverlayFromFile(vr::IVROverlay* self, vr::VROverlayHandle_t ulOverlayHandle, char * pchFilePath);
...
TRUSS_C_API vr::EVROverlayError tr_ovw_CreateDashboardOverlay(vr::IVROverlay* self, char * pchOverlayKey, char * pchOverlayFriendlyName, vr::VROverlayHandle_t * pMainHandle, vr::VROverlayHandle_t * pThumbnailHandle);
...
TRUSS_C_API void tr_ovw_ShowDashboard(vr::IVROverlay* self, char * pchOverlayToShow);
TRUSS_C_API vr::TrackedDeviceIndex_t tr_ovw_GetPrimaryDashboardDevice(vr::IVROverlay* self);
TRUSS_C_API vr::EVROverlayError tr_ovw_ShowKeyboard(vr::IVROverlay* self, vr::EGamepadTextInputMode eInputMode, vr::EGamepadTextInputLineMode eLineInputMode, char * pchDescription, uint32_t unCharMax, char * pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
TRUSS_C_API vr::EVROverlayError tr_ovw_ShowKeyboardForOverlay(vr::IVROverlay* self, vr::VROverlayHandle_t ulOverlayHandle, vr::EGamepadTextInputMode eInputMode, vr::EGamepadTextInputLineMode eLineInputMode, char * pchDescription, uint32_t unCharMax, char * pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
...
TRUSS_C_API vr::VRMessageOverlayResponse tr_ovw_ShowMessageOverlay(vr::IVROverlay* self, char * pchText, char * pchCaption, char * pchButton0Text, char * pchButton1Text, char * pchButton2Text, char * pchButton3Text);
TRUSS_C_API vr::EVRRenderModelError tr_ovw_LoadRenderModel_Async(vr::IVRRenderModels* self, char * pchRenderModelName, vr::RenderModel_t ** ppRenderModel);
...
TRUSS_C_API uint32_t tr_ovw_GetComponentCount(vr::IVRRenderModels* self, char * pchRenderModelName);
TRUSS_C_API uint32_t tr_ovw_GetComponentName(vr::IVRRenderModels* self, char * pchRenderModelName, uint32_t unComponentIndex, char * pchComponentName, uint32_t unComponentNameLen);
TRUSS_C_API uint64_t tr_ovw_GetComponentButtonMask(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchComponentName);
TRUSS_C_API uint32_t tr_ovw_GetComponentRenderModelName(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchComponentName, char * pchComponentRenderModelName, uint32_t unComponentRenderModelNameLen);
TRUSS_C_API bool tr_ovw_GetComponentState(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchComponentName, vr::VRControllerState_t * pControllerState, vr::RenderModel_ControllerMode_State_t * pState, vr::RenderModel_ComponentState_t * pComponentState);
TRUSS_C_API bool tr_ovw_RenderModelHasComponent(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchComponentName);
TRUSS_C_API uint32_t tr_ovw_GetRenderModelThumbnailURL(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchThumbnailURL, uint32_t unThumbnailURLLen, vr::EVRRenderModelError * peError);
TRUSS_C_API uint32_t tr_ovw_GetRenderModelOriginalPath(vr::IVRRenderModels* self, char * pchRenderModelName, char * pchOriginalPath, uint32_t unOriginalPathLen, vr::EVRRenderModelError * peError);
...
TRUSS_C_API void tr_ovw_SetInt32(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, int32_t nValue, vr::EVRSettingsError * peError);
TRUSS_C_API void tr_ovw_SetFloat(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, float flValue, vr::EVRSettingsError * peError);
TRUSS_C_API void tr_ovw_SetString(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, char * pchValue, vr::EVRSettingsError * peError);
TRUSS_C_API bool tr_ovw_GetBool(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, vr::EVRSettingsError * peError);
TRUSS_C_API int32_t tr_ovw_GetInt32(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, vr::EVRSettingsError * peError);
TRUSS_C_API float tr_ovw_GetFloat(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, vr::EVRSettingsError * peError);
TRUSS_C_API void tr_ovw_GetString(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, char * pchValue, uint32_t unValueLen, vr::EVRSettingsError * peError);
TRUSS_C_API void tr_ovw_RemoveSection(vr::IVRSettings* self, char * pchSection, vr::EVRSettingsError * peError);
TRUSS_C_API void tr_ovw_RemoveKeyInSection(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, vr::EVRSettingsError * peError);
TRUSS_C_API vr::EVRScreenshotError tr_ovw_RequestScreenshot(vr::IVRScreenshots* self, vr::ScreenshotHandle_t * pOutScreenshotHandle, vr::EVRScreenshotType type, char * pchPreviewFilename, char * pchVRFilename);
...
TRUSS_C_API vr::EVRScreenshotError tr_ovw_TakeStereoScreenshot(vr::IVRScreenshots* self, vr::ScreenshotHandle_t * pOutScreenshotHandle, char * pchPreviewFilename, char * pchVRFilename);
TRUSS_C_API vr::EVRScreenshotError tr_ovw_SubmitScreenshot(vr::IVRScreenshots* self, vr::ScreenshotHandle_t screenshotHandle, vr::EVRScreenshotType type, char * pchSourcePreviewFilename, char * pchSourceVRFilename);
TRUSS_C_API uint32_t tr_ovw_LoadSharedResource(vr::IVRResources* self, char * pchResourceName, char * pchBuffer, uint32_t unBufferLen);
TRUSS_C_API uint32_t tr_ovw_GetResourceFullPath(vr::IVRResources* self, char * pchResourceName, char * pchResourceTypeDirectory, char * pchPathBuffer, uint32_t unBufferLen);
