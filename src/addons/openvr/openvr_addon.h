...
TRUSS_C_API vr::HmdMatrix44_t tr_ovw_GetProjectionMatrix(vr::IVRSystem* self, vr::EVREye eEye, float fNearZ, float fFarZ, vr::EGraphicsAPIConvention eProjType);
...
TRUSS_C_API vr::DistortionCoordinates_t tr_ovw_ComputeDistortion(vr::IVRSystem* self, vr::EVREye eEye, float fU, float fV);
...
TRUSS_C_API vr::EVROverlayError tr_ovw_GetOverlayTexture(vr::IVROverlay* self, vr::VROverlayHandle_t ulOverlayHandle, void ** pNativeTextureHandle, void * pNativeTextureRef, uint32_t * pWidth, uint32_t * pHeight, uint32_t * pNativeFormat, vr::EGraphicsAPIConvention * pAPI, vr::EColorSpace * pColorSpace);
...
TRUSS_C_API int32_t tr_ovw_GetInt32(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, int32_t nDefaultValue, vr::EVRSettingsError * peError);
...
TRUSS_C_API float tr_ovw_GetFloat(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, float flDefaultValue, vr::EVRSettingsError * peError);
...
TRUSS_C_API void tr_ovw_GetString(vr::IVRSettings* self, char * pchSection, char * pchSettingsKey, char * pchValue, uint32_t unValueLen, char * pchDefaultValue, vr::EVRSettingsError * peError);
